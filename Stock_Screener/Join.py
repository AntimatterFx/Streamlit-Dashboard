...
def Join():
    ...
    df2 = pd.read_csv('Dashboard\Stock_Screener\SAVE\MA.csv',index_col= 0)
    df2 = df2.replace('-',np.nan)
    ult = df2.copy()

    #Join the Data based on Fundmental 
    #df = pd.read_csv('Dashboard\Stock_Screener\SAVE\Fund.csv',index_col = 0)
    df = pd.read_csv('Dashboard\Stock_Screener\SAVE\FUND.csv',index_col = 0)
    ...
    #Join MACD with MA
    df = pd.read_csv('Dashboard\Stock_Screener\SAVE\MACD_Daily.csv',index_col= 0)
    ...
    #Joing MTUM
    EMA = pd.read_csv('Dashboard\Stock_Screener\SAVE\MTUM_EMA.csv',index_col= 0)
    MA = pd.read_csv('Dashboard\Stock_Screener\SAVE\MTUM_MA.csv',index_col= 0)
    #print(len(MA))
    #print(len(EMA))
    ...
    weeklydf = pd.read_csv('Dashboard\Stock_Screener\SAVE\MACD_Weekly.csv',index_col= 0)
    ...
    ultdf.to_csv('Dashboard\Stock_Screener\SAVE\Stocks Table.csv')
