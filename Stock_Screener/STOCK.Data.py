...
def Daily():
    ...
    df = pd.read_csv('Dashboard\Stock_Screener\SAVE\FUND.csv')
    ...
    stocks_daily.to_csv('Dashboard\Stock_Screener\SAVE\STOCKS_Daily.csv')
...
def Weekly():
    ...
    #stocks_daily = stocks_daily[:-1] # removes last row
    stocks_daily.to_csv('Dashboard\Stock_Screener\SAVE\STOCKS_Weekly.csv')
